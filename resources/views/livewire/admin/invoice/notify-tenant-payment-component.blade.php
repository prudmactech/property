            ...
            <div class="nk-modal">
                ...
                <div class="nk-modal-text">
                    <div class="caption-text">{{ __('Notify tenant')}} <strong> {{ $tenant_name }}</strong>
                     {{ __('to pay pending bills amounting to')}} <strong>{{setting('currency_symbol')}} {{ $balance }}</strong>
                ...
                <div class="nk-modal-action">
                    ...
                    <x-button loading="{{ __('Sending email,please wait...') }}" wire:click="submit" class="btn btn-primary">
