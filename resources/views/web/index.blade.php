                    ...
                    <div class="header-caption">
                        <div class="header-badge">
                            <div class="badge-pro">
                                ...
                                <span class="badge-pro-text">Rentals Management System</span>
                            </div>
                        </div>
                ...
                <div class="col-lg-9 col-md-10">
                    <div class="text-block is-compact py-3">
                        ...
                        <p>{{ __('Whether you manage five doors or five thousand, you need a simple, unified platform that
                            powers you to be your best.Choose Rental Management System today so you can scale your
                            tomorrow.')}}
                        </p>
                        <ul class="btns-inline justify-center pt-2">
                            <li><a href="#" class="btn btn-xl btn-primary btn-round">{{ __('Buy RMS Today')}}</a></li>
                        </ul>
                    </div>
                </div>
            </div>
